...
const Auth = {
  ...
  ALL_PAGES: ['dashboard','pointage','recettes','depenses','validation','analyse','prix','banque','mobile','suivi','categories','employes','comptes-emp','credits','fournisseurs','stock','associes','bilan','clotures','historique'],

  ROLE_PERMISSIONS: {
    admin:       ['*'],
    responsable: ['dashboard','pointage','recettes','depenses','validation','analyse','prix','banque','mobile','suivi','categories','employes','comptes-emp','credits','fournisseurs','stock','associes','bilan','clotures'],
    gerant:      ['dashboard','pointage','recettes','depenses','validation','analyse','prix','banque','mobile','suivi','categories','employes','comptes-emp','credits','fournisseurs','stock','bilan'],
